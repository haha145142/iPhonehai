...
enum PresetLibrary {
    static let all: [CameraPreset] = {
        let bases: [(String,String,String,String,String,String,String,String,Double,Double,Double,Double,Double,Double,Double,Double,String,String)] = [
            ...
            ("LEICA","SL3","VARIO-ELMARIT-SL 24-90","50mm","F2.8","ISO 100","1/250s", "徕卡 SL", 0.94,1.07,0.95,0.10,0.28,0,0,"Leica Camera AG","LEICA SL3"),
            ("LEICA","D-LUX 8","DC VARIO-SUMMILUX","24mm","F1.7","ISO 100","1/320s", "徕卡 D-LUX", 0.90,1.05,0.90,0.08,0.22,0,0,"Leica Camera AG","LEICA D-LUX 8"),
            ("HASSELBLAD","X2D 100C","XCD 2,5/38V","38mm","F2.5","ISO 64","1/320s", "哈苏自然", 0.86,1.03,0.92,0.14,0.22,0,0,"Hasselblad","X2D 100C"),
            ("HASSELBLAD","X2D 100C","XCD 2,5/55V","55mm","F2.5","ISO 64","1/320s", "哈苏人像", 0.87,1.03,0.90,0.16,0.22,0,0,"Hasselblad","X2D 100C"),
            ("HASSELBLAD","907X","XCD 4/45P","45mm","F4.0","ISO 100","1/320s", "哈苏中画幅", 0.87,1.02,0.94,0.14,0.20,0,0,"Hasselblad","907X"),
            ("ZEISS","ZX1","Distagon 2/35","35mm","F2.0","ISO 100","1/250s", "蔡司自然色", 0.98,1.12,0.90,0.06,0.34,-2,0,"ZEISS","ZX1"),
            ("ZEISS","Otus 55","Otus 1.4/55","55mm","F1.4","ISO 100","1/500s", "蔡司微反差", 0.97,1.14,0.92,0.07,0.42,-1,0,"ZEISS","Otus 55"),
            ("VIVO","X200 Ultra","ZEISS Master","35mm","F1.2","ISO 50","1/250s", "vivo 蔡司大师", 1.06,1.06,0.96,0.12,0.26,2,0,"vivo","X200 Ultra"),
            ("VIVO","X200 Pro","ZEISS Tele","50mm","F1.6","ISO 50","1/250s", "vivo 蔡司长焦", 1.04,1.05,0.94,0.12,0.28,1,0,"vivo","X200 Pro"),
            ("VIVO","X100 Ultra","ZEISS APO Tele","85mm","F2.5","ISO 64","1/320s", "vivo 蔡司人像", 1.03,1.05,0.92,0.18,0.24,1,1,"vivo","X100 Ultra"),
            ("XIAOMI","15 Ultra","Leica Summilux","23mm","F1.63","ISO 50","1/250s", "小米徕卡", 0.96,1.10,0.93,0.09,0.30,0,0,"Xiaomi","15 Ultra"),
            ("XIAOMI","15 Ultra","Leica Portrait 75","75mm","F2.5","ISO 64","1/320s", "小米徕卡人像", 0.95,1.08,0.90,0.16,0.25,0,0,"Xiaomi","15 Ultra"),
            ("XIAOMI","14 Ultra","Leica Vario-Summilux","23mm","F1.63","ISO 50","1/250s", "小米徕卡经典", 0.96,1.08,0.93,0.10,0.28,0,0,"Xiaomi","14 Ultra"),
            ("HUAWEI","Pura 70 Ultra","XMAGE","24mm","F1.6","ISO 50","1/200s", "华为 XMAGE", 1.05,1.06,0.93,0.11,0.25,2,1,"HUAWEI","Pura 70 Ultra"),
            ("HUAWEI","Mate 70 Pro","XMAGE","24mm","F1.4","ISO 50","1/200s", "华为 XMAGE 大师", 1.04,1.05,0.92,0.11,0.28,2,1,"HUAWEI","Mate 70 Pro"),
            ("OPPO","Find X8 Ultra","Hasselblad","23mm","F1.8","ISO 50","1/250s", "OPPO 哈苏", 1.03,1.05,0.92,0.15,0.27,1,0,"OPPO","Find X8 Ultra"),
            ("OPPO","Find X7 Ultra","Hasselblad","23mm","F1.8","ISO 50","1/250s", "OPPO 哈苏自然", 1.03,1.05,0.94,0.13,0.25,1,0,"OPPO","Find X7 Ultra"),
            ("GOOGLE","Pixel 10 Pro","Computational","25mm","F1.7","ISO 50","1/250s", "谷歌计算摄影", 1.02,1.04,0.92,0.12,0.34,0,0,"Google","Pixel 10 Pro"),
            ("GOOGLE","Pixel 9 Pro","Computational","25mm","F1.7","ISO 50","1/250s", "谷歌自然", 1.03,1.04,0.93,0.11,0.32,0,0,"Google","Pixel 9 Pro"),
            ("APPLE","iPhone 17 Pro","Main","24mm","F1.78","ISO 50","1/250s", "苹果专业", 1.00,1.03,0.95,0.12,0.26,0,0,"Apple","iPhone 17 Pro"),
            ("APPLE","iPhone 17 Pro Max","Main","24mm","F1.78","ISO 50","1/250s", "苹果专业", 1.00,1.03,0.95,0.12,0.26,0,0,"Apple","iPhone 17 Pro Max"),
            ("SONY","α1 II","G Master","35mm","F1.4","ISO 100","1/500s", "索尼 G Master", 0.98,1.10,0.94,0.08,0.38,-1,0,"SONY","ILCE-1M2"),
            ("SONY","α7R V","G Master","35mm","F1.4","ISO 100","1/500s", "索尼高解析", 0.98,1.10,0.93,0.08,0.36,-1,0,"SONY","ILCE-7RM5"),
            ("CANON","EOS R5 Mark II","RF L","50mm","F1.2","ISO 100","1/500s", "佳能 RF L", 1.01,1.08,0.93,0.10,0.30,1,0,"Canon","Canon EOS R5 Mark II"),
            ("NIKON","Z8","NIKKOR Z","50mm","F1.8","ISO 64","1/500s", "尼康 NIKKOR Z", 1.00,1.08,0.94,0.10,0.32,0,0,"NIKON CORPORATION","NIKON Z 8"),
            ("FUJIFILM","X100VI","FUJINON","23mm","F2.0","ISO 125","1/250s", "富士胶片", 0.96,1.06,0.90,0.12,0.26,1,-1,"FUJIFILM","X100VI"),
            ("RICOH","GR IIIx","GR Lens","40mm","F2.8","ISO 100","1/500s", "理光街拍", 0.95,1.05,0.91,0.09,0.42,-1,0,"RICOH IMAGING COMPANY, LTD.","RICOH GR IIIx"),
            ("PANASONIC","S1RII","LUMIX S PRO","50mm","F1.8","ISO 100","1/500s", "松下自然", 0.98,1.07,0.94,0.11,0.33,0,0,"Panasonic","DC-S1RM2"),
